...
dapui.setup({
	...
	layouts = {
		{
			elements = {
				{ id = "scopes", size = 0.5 }, -- 50% of this panel is scopes
				{ id = "console", size = 0.25 }, -- 25% of this panel is scopes
				{ id = "stacks", size = 0.25 }, -- 25% of this panel is scopes
			},
...
local map, _ = vim.keymap.set, { noremap = true, silent = true }
